# Optimization for Computer Vision Course — Final Project

This repository contains my final project for the **Optimization for Computer Vision** course.  
...
- **`images_test/`**: additional test images for extra experiments especially illumination enhancement.
